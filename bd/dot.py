...
class BlueDot(object):
    ...
    def __init__(self,
        ...
        self._is_manual_pressed_event = Event()
        self._is_auto_pressed_event = Event()
        ...
        self._when_manual_pressed = None
        self._when_manual_pressed_background = False

        self._when_auto_pressed = None
        self._when_auto_pressed_background = False
    ...
    @property
    def when_auto_pressed(self):
        return self._when_auto_pressed

    @when_auto_pressed.setter
    def when_auto_pressed(self, value):
        self.set_when_auto_pressed(value)

    def set_when_auto_pressed(self, callback, background=False):
        self._when_auto_pressed = callback
        self._when_auto_pressed_background = background

    @property
    def when_manual_pressed(self):
        return self._when_manual_pressed

    @when_manual_pressed.setter
    def when_manual_pressed(self, value):
        self.set_when_manual_pressed(value)

    def set_when_manual_pressed(self, callback, background=False):
        self._when_manual_pressed = callback
        self._when_manual_pressed_background = background
    ...
    def wait_for_auto_press(self, timeout=None):
        return self._is_auto_pressed_event.wait(timeout)

    def wait_for_manual_press(self, timeout=None):
        return self._is_manual_pressed_event.wait(timeout)
    ...
    def _process_commands(self, commands):
        for command in commands:
            try:
                ...
                if operation == "1" or operation == "2" or operation == "0":
    ...
    def _auto_pressed(self):
        ...
        self._process_callback(self.when_auto_pressed, None, self._when_auto_pressed_background)
    ...
    def _manual_pressed(self):
        ...
        self._process_callback(self.when_manual_pressed, None, self.when_manual_pressed)
